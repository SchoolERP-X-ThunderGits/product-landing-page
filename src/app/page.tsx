                        ...
                        <div className="mt-24 bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl overflow-hidden shadow-xl">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                                ...
                                <div className="p-10 text-white">
                                    <h2 className="text-3xl font-bold mb-6 text-white">Experience EduGits in Action</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-8">
                            ...
                            <form className="space-y-8">
                                ...
                                <button
                                    type="submit"
                                    className="mt-8 w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-md"
                                >
                                    Send Message
                                </button>
                            </form>
